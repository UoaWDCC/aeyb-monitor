...
type EditMeetingProps = {
    ...
    setIsEditMeetingOpen: (value: boolean) => void;
    meeting: MeetingDTO;
};
export default function EditMeeting({ isEditMeetingOpen, setIsEditMeetingOpen, meeting }: EditMeetingProps) {
    ...
    const defaultValues: FormValuesType = {
        name: name,
        type: 'meeting',
        location: { location: location.location, type: 'inPerson' },
    ...
    return (
        <>
            {isEditMeetingOpen ? (
                <div className="flex items-center justify-center fixed h-screen w-full top-0 left-0 z-20">
                    ...
                    <div className="text-5xl bg-white p-10 opacity-100 z-30 rounded-lg w-1/2 flex flex-col items-center relative">
                        ...
                        <h1 className="my-5">Edit meeting</h1>
            ...
            {showModal && (
                <ConfirmModal
                    header="Edit Meeting"
                    text="Are you sure you want to edit meeting?"
                    leftButtonText="Yes"
                    rightButtonText="No"
